...
function About() {
  ...
  return (
    <>
      <section id="about" className="about-section section-padding section-with-bg-logo">
      <Container>
        <Row>
          <Col>
        ...
        <Row className="align-items-center">
          ...
          <Col lg={6}>
            ...
            <p className="mb-4">
              ...
              outdoors,listening to music, or experimenting with new recipes in
              the kitchen.
            </p>
            <p>
              And also Interested in exploring the other side of thrilling life
              in bikes and in hills
            </p>
            <Row className="mt-4">
              <Col sm={6}>
    ...
    </section><section className="py-5 bg-light reveal-section" id="education">
        <Container>
            ...
            <Col md={4}>
              <Card className="education-card h-100 text-center">
                <Card.Body>
                  ...
                  <Badge bg="primary" className="mb-2">2022 - 2026</Badge>
                  <p className="text-muted small mb-0">Expected Graduation: 2026</p>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="education-card h-100 text-center">
                <Card.Body>
                  ...
                  <Badge bg="success" className="mb-2">2020 - 2022</Badge>
            ...
            <Col md={4}>
              <Card className="education-card h-100 text-center">
                <Card.Body>
                  ...
                  <p className="card-text mb-1">R.N Oxford Matriculation School</p>
                  <Badge bg="warning" className="text-dark mb-2">2014 - 2020</Badge>
